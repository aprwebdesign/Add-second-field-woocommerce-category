...
* Description: Insert a brief description of what this plugin does here.
* Version: 1.0.0
* Author: Your Name
...
//READ THIS:
// This is not my own code, source: http://www.wpmusketeer.com/add-a-wysiwyg-field-to-woocommerce-product-category-page/
// Do add your own name and desc to the plugin file
...
function wpm_product_cat_edit_details_meta( $term ) {
	...
	?>
	<tr class="form-field">
		<th scope="row" valign="top"><label for="wpm-product-cat-details"><?php esc_html_e( 'Extra omschrijving (onderaan)', 'wpm' ); ?></label></th>
		<td>
